...
var (
	...
	UpgradeContractAddress, _    = common.AddressParseFromBytes([]byte{0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x09})
	//WARN: when add Contract Here, please update IsNativeContract function bellow.
)

func IsNativeContract(addr common.Address) bool {
	switch addr {
	case OntContractAddress, GasContractAddress, DIDContractAddress,
